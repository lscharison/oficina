  ...
  return (
    <div className={style.wrapper}>
      ...
      <$T params={{n: 8, money: 50}}>
        ...
        {/* <div className='row'>
          <button onClick={() => showAlertHydra(1)}>弹出ALERT--1</button>
        </div>
        <div className='row'>
          <button onClick={() => showAlertHydra(2)}>弹出ALERT--2</button>
        </div> */}
        <div className='row'>
          <button onClick={() => showAlertHydra(3)}>弹出ALERT--3</button>
        </div>
        <div className='row'>
          <button onClick={() => showAlertHydra(4)}>弹出ALERT--4</button>
        </div>
        <div className='row'>

...
const DpImage = (props: IProps) => {
  ...
  return ((!props.fallback && err) || !props.src) ? errNode : <Image preview={false} onError={() => setErr(true)} {...props} rootClassName={props.className} placeholder={props.type ? errNode : null}></Image>;
};

...
import {EDARK, ELIGHT} from '../../configs';
...
export interface SvgIconProps {
  ...
  className?: string;
  active?: boolean;
  theme?: typeof ELIGHT | typeof EDARK;
}
...
export function IconClose({width = 6, height = 6, fill, active, theme}: SvgIconProps) {
  return (
    <svg width={width} height={height} viewBox='0 0 6 6'>
      <path
        id='Vector'
        d='M3 3L1 1M3 3L5 5M3 3L5 1M3 3L1 5'
        stroke='white'
        strokeLinecap='round'
        strokeLinejoin='round'
...
export function IconCloseEye({width = 16, height = 16, fill, active, theme}: SvgIconProps) {
  return (
    <svg width={width} height={height} viewBox='0 0 1024 1024' version='1.1'>
      <path
        d='M348.5 287.5c52.7-18.9 108.4-28.4 164.5-28 165.5 0 300.7 74.2 405.6 222.4 12.5 17.7 12.6 41 0.2 58.7-45.4 65.1-97 115.8-154.7 152.3l69.3 67.7-37.6 36.7-547.2-534 37.6-36.6 62.3 60.8z m304.1 296.7c12.7-21.6 19.8-46.5 19.8-73 0-83.4-71.4-151.1-159.5-151.1-26.3 0-51 6-72.9 16.7l62.1 60.7c3.6-0.5 7.2-0.7 10.9-0.7 44.1 0 79.7 33.8 79.7 75.5 0 4.3-0.4 8.5-1.1 12.6l61 59.3zM250.7 337.7l116.1 113.2c-8.5 18.5-13.2 38.9-13.2 60.3 0 83.4 71.4 151 159.5 151 20.9 0 40.9-3.8 59.3-10.8l91 88.8c-48.5 15.4-99.3 23-150.3 22.7-166.9 0-302.1-74.1-405.7-222.3-12.4-17.7-12.3-41.1 0.2-58.8 42.5-60.2 90.3-108.3 143.1-144.1z m256.1 250c-39.8-3.1-71.3-33.7-73.3-71.6l73.3 71.6z'
        fill={fill || (active && 'white') || theme.dpAncillary}
      />
    </svg>
  );
...
export function IconLive({width = 20, height = 20, fill, active, theme}: SvgIconProps) {
  return (
    <svg width={width} height={height} viewBox='0 0 20 20' fill='none'>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
        d='M1 5C1 3.89543 1.89543 3 3 3H17C18.1046 3 19 3.89543 19 5V15C19 16.1046 18.1046 17 17 17H3C1.89543 17 1 16.1046 1 15V5ZM13.5069 7.19995H17.0635V8.35472H14.837V9.21434H16.9024V10.3175H14.837V11.3837H17.128V12.6085H13.5069V7.19995ZM9.80378 7.19995H8.41511L10.0382 12.6085H11.4766L13.0704 7.19995H11.7227L10.7706 11.0922L9.80378 7.19995ZM6.55479 7.19995H7.88487V12.6085H6.55479V7.19995ZM3.8271 7.19995H2.49995V12.6085H5.89839V11.2767H3.8271V7.19995Z'
        fill={fill || (active && theme.dpTheme) || theme.dpAncillary}
      />
    </svg>
  );
...
export function IconEye({width = 16, height = 16, fill, active, theme}: SvgIconProps) {
  return (
    <svg width={width} height={height} viewBox='0 0 1024 1024' version='1.1'>
      <path
        d='M513 772.7c-167.2 0-302.6-76.8-406.1-230.3-11.9-17.6-11.8-40.7 0.2-58.3C212 330.5 347.3 253.7 513 253.7s301 76.8 406 230.4c12 17.6 12 40.7 0.2 58.3-103.6 153.5-239 230.3-406.2 230.3z m0-103.8c88 0 159.3-69.7 159.3-155.7S601 357.5 513 357.5s-159.3 69.7-159.3 155.7S425 668.9 513 668.9z m0.2-76.7c-44 0-79.7-34.8-79.7-77.9 0-43 35.7-77.9 79.7-77.9s79.6 34.9 79.6 77.9c0 43-35.6 77.9-79.6 77.9z'
        fill={fill || (active && 'white') || theme.dpAncillary}
      />
    </svg>
  );
...
export function IconSearch({width = 12, height = 12, fill, active, theme}: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 12 12" fill="none">
      <path d="M8.5 8.5L10.5 10.5M1.5 5.5C1.5 6.56087 1.92143 7.57828 2.67157 8.32843C3.42172 9.07857 4.43913 9.5 5.5 9.5C6.56087 9.5 7.57828 9.07857 8.32843 8.32843C9.07857 7.57828 9.5 6.56087 9.5 5.5C9.5 4.43913 9.07857 3.42172 8.32843 2.67157C7.57828 1.92143 6.56087 1.5 5.5 1.5C4.43913 1.5 3.42172 1.92143 2.67157 2.67157C1.92143 3.42172 1.5 4.43913 1.5 5.5Z" stroke="#BFBFC0" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function IconClear({width = 6, height = 6, fill, active, theme}: SvgIconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 3L1 1M3 3L5 5M3 3L5 1M3 3L1 5" stroke="#ED3737" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconConfirmed({width = 6, height = 6, fill, active, theme}: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M7 0.875C8.62445 0.875 10.1824 1.52031 11.331 2.66897C12.4797 3.81763 13.125 5.37555 13.125 7C13.125 8.62445 12.4797 10.1824 11.331 11.331C10.1824 12.4797 8.62445 13.125 7 13.125C5.37555 13.125 3.81763 12.4797 2.66897 11.331C1.52031 10.1824 0.875 8.62445 0.875 7C0.875 5.37555 1.52031 3.81763 2.66897 2.66897C3.81763 1.52031 5.37555 0.875 7 0.875ZM6.237 8.20837L4.87638 6.84687C4.8276 6.7981 4.76969 6.7594 4.70596 6.73301C4.64223 6.70661 4.57392 6.69302 4.50494 6.69302C4.43596 6.69302 4.36765 6.70661 4.30392 6.73301C4.24019 6.7594 4.18228 6.7981 4.1335 6.84687C4.03499 6.94539 3.97965 7.079 3.97965 7.21831C3.97965 7.35763 4.03499 7.49124 4.1335 7.58975L5.866 9.32225C5.91464 9.37127 5.9725 9.41018 6.03625 9.43673C6.1 9.46329 6.16838 9.47696 6.23744 9.47696C6.3065 9.47696 6.37487 9.46329 6.43862 9.43673C6.50237 9.41018 6.56023 9.37127 6.60887 9.32225L10.1964 5.73387C10.2458 5.6853 10.2851 5.62742 10.3121 5.56357C10.339 5.49972 10.3531 5.43117 10.3534 5.36187C10.3537 5.29256 10.3403 5.22388 10.314 5.15979C10.2876 5.09569 10.2488 5.03745 10.1998 4.98841C10.1509 4.93938 10.0927 4.90053 10.0286 4.8741C9.96454 4.84767 9.89587 4.83419 9.82657 4.83443C9.75727 4.83467 9.6887 4.84863 9.62482 4.8755C9.56094 4.90237 9.50301 4.94163 9.45438 4.991L6.237 8.20837Z" fill="#64E156"/>
    </svg>
  );
}
...
export function IconAdd2({width = 6, height = 6, fill, active, theme}: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8" fill="none">
      <path fillRule="evenodd" clipRule="evenodd" d="M3.33333 4.66536V8H4.66667V4.66536H8V3.33203H4.66667V0H3.33333V3.33203H0V4.66536H3.33333Z" fill="#B2B2B2"/>
    </svg>
  );
}
...
export function IconGameDetailView({width = 14, height = 14, fill, active, theme}: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 14 14" fill="none">
      <path d="M13 3.24952V10.7505C13 11.3692 12.7785 11.9001 12.3393 12.3393C11.9001 12.7785 11.3692 13 10.7505 13H3.24952C2.63081 13 2.09994 12.7785 1.66073 12.3393C1.22151 11.9001 1 11.3692 1 10.7505V3.24952C1 2.63081 1.22151 2.09994 1.66073 1.66073C2.09994 1.22151 2.63081 1 3.24952 1H10.7505C11.3692 1 11.9001 1.22151 12.3393 1.66073C12.7785 2.09994 13 2.63081 13 3.24952Z" fill="#3586FF"/>
...
export function IconFilterDescending({width = 14, height = 14, fill, active, theme}: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 14 14" fill="none">
      ...
      <path d="M9.51291 1.50796H8.14026V12.6355L12.6875 8.46968L11.7606 7.45796L9.51291 9.51558V1.50796Z" fill="#3586FF"/>
    </svg>
  );
}
...
export function IconFilterAscending({width = 14, height = 14, fill, active, theme}: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 14 14" fill="none">
      ...
      <path d="M9.51291 1.50796H8.14026V12.6355L12.6875 8.46968L11.7606 7.45796L9.51291 9.51558V1.50796Z" fill="#BFBFC0"/>
    </svg>
  );
}
...
export function IconVideoNext({width = 24, height = 24, fill, active, theme}: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" fill="none">
      <rect x="-0.25" y="0.25" width="23.5" height="23.5" rx="11.75" transform="matrix(-1 0 0 1 23.5 0)" stroke="#DBDBDB" strokeWidth="0.5"/>
...
export function IconLine({width = 2, height = 14, fill, active, theme}: SvgIconProps) {
  return (
    <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill="none">
      <path d="M2 0.5L1.65836 0.670821C0.642007 1.179 0 2.21779 0 3.3541V10.6459C0 11.7822 0.642007 12.821 1.65836 13.3292L2 13.5V0.5Z" fill={fill || theme.dpTheme}/>
    </svg>
  );
}
